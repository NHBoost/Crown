...
import { SocialLaptop } from "@/components/mockups/SocialLaptop";
import { SocialPhone } from "@/components/mockups/SocialPhone";
    ...
    <section className="relative flex min-h-screen flex-col justify-center overflow-hidden bg-blanc px-6 pt-28 sm:px-14 sm:pt-[100px]">
      ...
      <div className="relative mx-auto grid w-full max-w-[1280px] items-center gap-10 [&>*]:min-w-0 lg:grid-cols-2 lg:gap-16">
        ...
        <div className="relative">
          ...
          >
            L&apos;équipe derrière{" "}
            <em className="not-italic italic text-or">vos résultats.</em>
          </h1>
          ...
          >
            Depuis 2018, nous accompagnons les marques ambitieuses en stratégie,
            création et performance. Des profils complémentaires, une méthode
            commune.
          </p>
