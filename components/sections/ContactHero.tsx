...
import { WebsiteLaptop } from "@/components/mockups/WebsiteLaptop";
import { WebsitePhone } from "@/components/mockups/WebsitePhone";
    ...
    <section className="relative flex min-h-screen flex-col justify-center overflow-hidden bg-blanc px-6 pt-28 sm:px-14 sm:pt-[100px]">
      ...
      <div className="relative mx-auto grid w-full max-w-[1280px] items-center gap-10 [&>*]:min-w-0 lg:grid-cols-2 lg:gap-16">
        ...
        <div className="relative">
          ...
          >
            Un projet ambitieux ?{" "}
            <em className="not-italic italic text-or">Parlons-en.</em>
          </h1>
          ...
          >
            Décrivez-nous vos enjeux en quelques lignes. Notre équipe revient
            sous 24h avec une première lecture stratégique — gratuite et sans
            engagement.
          </p>
        ...
        {/* RIGHT — responsive website mockup */}
        <div
